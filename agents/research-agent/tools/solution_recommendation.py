...
def solution_recommendation(query: str = "", problem: str = "", **kwargs) -> dict:
    ...
    prompt = f"""Given this computer vision research problem, recommend practical solutions. Return ONLY valid JSON with:
...
Problem: {problem_name}"""
    raw = call_llm(system_prompt="You are a computer vision solution architect.", user_prompt=prompt)
