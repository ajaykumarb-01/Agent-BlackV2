...
def prototype_guidance(query: str = "", problem: str = "", **kwargs) -> dict:
    ...
    prompt = f"""Provide prototype development guidance for this ML use case. Return ONLY valid JSON with:
...
Use case: {problem_name}"""
    raw = call_llm(system_prompt="You are an ML prototype development expert.", user_prompt=prompt)
